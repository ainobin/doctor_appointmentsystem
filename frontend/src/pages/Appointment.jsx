...
const Appointment = () => {
    ...
    const getAvailableSlots = async () => {
        ...
        for (let i = 0; i < 7; i++) {
            ...
            while (currentDate < endTime) {
                ...
                const isSlotAvailable = docInfo.slots_booked[slotDate] && docInfo.slots_booked[slotDate].includes(slotTimeValue) ? false : true
    ...
    const bookAppointment = async () => {
        ...
        try {
            // স্লট সিলেক্ট করা হয়েছে কি না চেক করুন
            if (!slotTime) {
